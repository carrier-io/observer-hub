...
def process_results_for_test(report_id, scenario_name, scenario_results, thresholds, junit_report, junit_report_bucket):
    ...
    notify_on_test_end(report_id, threshold_results, None, junit_report_name, junit_report_bucket)
